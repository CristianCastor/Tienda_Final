...
<head>
	...
	doc.text(20,20,'Ticket de compra para la figura "Hata no Kokoro"');
...
<body>
    ...
    <main class="contenedor">
        ...
        <h1>Hata no Kokoro(Escala 1/7)</h1>
     </a>
        <div class="nosotros">
            <div class="nosotros__contenido">
                <p>Hata no Kokoro de Touhou Proyect</p>

                <p> Personaje Popular del videojuego Touhou 15.5 Hopeless Masquerade
                ...
                <form class="formulario">
                    ...
                    ?>
                    <?php
                    $sql= "SELECT * from inventario WHERE producto = 'Kokoro'";
            ...
            <img class="nosotros__imagen" src="img/fig12.jpg" alt="imagen nosotros">
        </div>
    </main>
    </div>
    <footer class="footer">
