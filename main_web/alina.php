...
<head>
	...
	doc.text(20,20,'Ticket de compra para la figura "Alina Gray"');
...
<body>
    ...
    <main class="contenedor">
        ...
        <h1>Alina Gray(Escala 1/7)</h1>
     </a>
        <div class="nosotros">
            <div class="nosotros__contenido">
                <p>Alina Gray de Magia Record</p>

                <p> Personaje Popular del videojuego Magireco
                </p>
                <form class="formulario">
                    <?php
                    ?>
                    <?php
                    $sql= "SELECT * from inventario WHERE producto = 'Alina'";
            ...
            <img class="nosotros__imagen" src="img/fig6.jpg" alt="imagen nosotros">
        </div>
    </main>
    </div>
    <footer class="footer">
