...
<head>
	...
	doc.text(20,20,'Ticket de compra para la figura "Keqing"');
...
<body>
    ...
    <main class="contenedor">
        ...
        <h1>Keqing(Escala 1/7)</h1>
     </a>
        <div class="nosotros">
            <div class="nosotros__contenido">
                <p>Keqing de Genshin Impact</p>
                ...
                <form class="formulario">
                    ...
                    ?>
                    <?php
                    $sql= "SELECT * from inventario WHERE producto = 'Keqing'";
            ...
            <img class="nosotros__imagen" src="img/fig3.jpg" alt="imagen nosotros">
        </div>
    </main>
    </div>
    <footer class="footer">
