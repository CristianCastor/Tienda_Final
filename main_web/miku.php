...
<head>
	...
	doc.text(20,20,'Ticket de compra para la Nendroid "Miku Nakano"');
...
<body>
    ...
    <main class="contenedor">
        ...
        <h1>Miku Nakano(Nendroid)</h1>
     </a>
        <div class="nosotros">
            <div class="nosotros__contenido">
                <p>Miku Nakano de Gotobun no Hanayome</p>

                <p> Personaje Popular de la serie Quintessencial Quintuplets
                </p>
                <form class="formulario">
                    <?php
                    ?>
                    <?php
                    $sql= "SELECT * from inventario WHERE producto = 'Miku'";
            ...
            <img class="nosotros__imagen" src="img/fig7.jpg" alt="imagen nosotros">
        </div>
    </main>
    </div>
    <footer class="footer">
