...
<head>
	...
	doc.text(20,20,'Ticket de compra para la figura "Violet(Persona 5)"');
    doc.text(10,10,'Precio 200$ DLLS"');
...
<body>
    ...
    <main class="contenedor">
        ...
        <h1>Violet(Escala 1/7)</h1>
     </a>
        <div class="nosotros">
            <div class="nosotros__contenido">
                <p>Violet de Persona 5 Royal</p>

                <p> Personaje Popular del videojuego Persona 5 Royal
                </p>
                <form class="formulario">
                    <?php
                    ?>
                    <?php
                    $sql= "SELECT * from inventario WHERE producto = 'Violet'";
            ...
            <img class="nosotros__imagen" src="img/fig11.jpg" alt="imagen nosotros">
        </div>
    </main>
    </div>
    <footer class="footer">
