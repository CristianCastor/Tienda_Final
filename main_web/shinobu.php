...
<head>
	...
	doc.text(20,20,'Ticket de compra para la figura "Shinobu Kocho"');
    doc.text(10,10,'Precio 130$ DLLS"');
    doc.text(30,30,'Unidad= 1');
	doc.save('Shinobu.pdf');
...
<body>
    ...
    <main class="contenedor">
        ...
        <h1>Shinobu Kocho(Escala 1/7)</h1>
     </a>
        <div class="nosotros">
            <div class="nosotros__contenido">
                <p>Shinobu Kocho de Kimetsu no Yaiba</p>

                <p> Personaje Popular de la serie Demon Slayer
                </p>
                <form class="formulario">
                    <?php
                    ?>
                    <?php
                    $sql= "SELECT * from inventario WHERE producto = 'Shinobu'";
            ...
            <img class="nosotros__imagen" src="img/fig10.jpg" alt="imagen nosotros">
        </div>
    </main>
    </div>
    <footer class="footer">
